...
* Display current To-Do's to terminal. Options include all To-Do's, filter incomplete To-Do's, filter To-Do's within a particular category, sort by date (ascending), and sort by priority (ascending). 

### Design
In our program, MVC design pattern was implemented to segregate the views from the model and controllers. MVC design enables to create separate and reusable models that can easily be updated; for example, updating the controller data affecting other packages.
